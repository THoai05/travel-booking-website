...
import { Star, Wifi, Utensils, Waves, Coffee, Building2, Search, MapPin, X, Filter, ChevronRight } from "lucide-react";
  ...
  const fakeHotels = [
    {
      ...
      price: 800000,
      stars: 4,
      amenities: ["Wifi miễn phí", "Hồ bơi"],
      image: "https://images.unsplash.com/photo-1542317854-03a9e4f1c9a6?w=1200&q=80",
      location: "Nha Trang",
      reviews: 124,
    },
    {
      ...
      price: 1200000,
      stars: 5,
      amenities: ["Nhà hàng", "Bữa sáng"],
      image: "https://images.unsplash.com/photo-1501117716987-c8e79f0c0b2b?w=1200&q=80",
      location: "Đà Nẵng",
      reviews: 210,
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1505691723518-36a9d5d65f0c?w=1200&q=80",
      location: "Hà Nội",
      reviews: 58,
    },
    {
      id: 4,
      name: "Khách sạn Núi Xanh",
      price: 700000,
      stars: 4,
      amenities: ["Hồ bơi", "Gần biển"],
    ...
    {
      id: 5,
      name: "Khách sạn Thành Phố",
      price: 600000,
      stars: 3,
      amenities: ["Wifi miễn phí", "Nhà hàng"],
      image: "https://images.unsplash.com/photo-1488747279002-c8523379faaa?w=1200&q=80",
  ...
  const applyFilter = () => {
    const filtered = fakeHotels.filter(
      (hotel) =>
        ...
        (amenities.length === 0 || amenities.every((a) => hotel.amenities.includes(a)))
    );
    setHotels(filtered);
    setShowFilter(false);
  };
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <h1 className="text-2xl font-bold">Tìm khách sạn</h1>
        ...
        >
          <div className="p-6 md:p-8">
            ...
            <div className="flex gap-3">
              <button onClick={applyFilter} className="bg-blue-400 text-white w-full py-2 rounded hover:bg-blue-300 flex items-center justify-center gap-2">
...
const HotelCard = ({ hotel }: { hotel: any }) => (
  <div className="rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 bg-white hover:-translate-y-1 group">
    ...
    <div className="p-5">
      <h3 className="font-bold text-lg text-gray-900 mb-1 line-clamp-1 group-hover:text-black">{hotel.name}</h3>
      <div className="flex items-center gap-1 text-gray-600 text-sm mb-3">
        <MapPin size={14} />
        <span>{hotel.location}</span>
      </div>
      <div className="flex items-center gap-2 mb-4 text-xs">
        <div className="flex text-yellow-400">{[...Array(hotel.stars)].map((_, i) => <Star key={i} size={14} fill="currentColor" stroke="none" />)}</div>
        <span className="text-gray-600">({hotel.reviews} đánh giá)</span>
      </div>
      <div className="flex items-center justify-between">
        <div>
          <p className="font-bold text-gray-900 text-xl">{hotel.price.toLocaleString()} ₫</p>
...
const NoResultsFound = ({ onReset }: { onReset: () => void }) => (
  <div className="text-center py-20 col-span-full">
    ...
    <button onClick={onReset} className="text-black font-semibold hover:underline">
      Xóa bộ lọc
    </button>
  </div>
);