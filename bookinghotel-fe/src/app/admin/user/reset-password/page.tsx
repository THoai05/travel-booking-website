...
interface ResetPasswordPageProps {
  setShowResetPasswordPage: (value: boolean) => void;
}

export default function ResetPasswordPage({ setShowResetPasswordPage }: ResetPasswordPageProps) {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      const data = await api.post("/reset-password/reset", { token, newPassword: password });
